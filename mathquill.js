...
LatexCmds.notsubsete = bind(BinaryOperator,'\\not\\subseteq ','&#8840;');
...
LatexCmds.notsupersete = LatexCmds.notsuperseteq =
  bind(BinaryOperator,'\\not\\supseteq ','&#8841;');
LatexCmds.notsubseteq =bind(BinaryOperator,'\\notsubseteq ','&#8842;');
...
var overdot = LatexCmds.overdot = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\overdot';
  _.htmlTemplate =
      '<span class="mq-non-leaf">'
    +   '<span class="mq-overdot-prefix">&middot;</span>'
    +   '<span class="mq-overdot-stem">&0</span>'
    + '</span>'
  ;
  _.textTemplate = ['hat(', ')'];
});
